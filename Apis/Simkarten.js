...
(function (factory) {
    ...
    var Simkarten = (function (_super) {
        ...
        Simkarten.prototype.read = function () {
            ...
            this.read_for_specific_project_and_subcategory_simkarten();
            this.read_all_simkarten();
        };
        Simkarten.prototype.read_for_specific_project_and_subcategory_simkarten = function () {
            var _this = this;
            this.app.get('/projektArtikelSimkarte/:projekt_id/:unterkategoriename', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var inputet_projekt_id, inputet_unterkategoriename, articles, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.allow_communikation_from_all_ip_adress(res);
        ...
        Simkarten.prototype.read_all_simkarten = function () {
            var _this = this;
            this.app.get('/projektArtikelSimkarte/:unterkategorie_id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var kategorie_id, articles, error_3;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
                            this.allow_communikation_from_all_ip_adress(res);
                            return [4, this.kategorienTable.look_up_kategorie_id(req.params.unterkategorie_id)];
                        case 1:
                            kategorie_id = _a.sent();
                            return [4, this.prisma.projekt_artikel.findMany({
                                    where: {
                                        artikel: {
                                            unterkategorie: {
        ...
        Simkarten.prototype.update = function () {
            ...
            this.app.put('/projektArtikelSimkarte', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var projektArtikelData, existingSimkarte, _a, simkarten_id, simkartenData, error_4;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            existingSimkarte = _b.sent();
                            if (!existingSimkarte) return [3, 4];
                            _a = projektArtikelData.artikel.simkarten, simkarten_id = _a.simkarten_id, simkartenData = __rest(_a, ["simkarten_id"]);
                            return [4, this.prisma.simkarten.update({
                                    where: {
                                        simkarten_id: simkarten_id
                                    },
                                    data: simkartenData
                                })];
                        case 3:
        ...
        Simkarten.prototype.deletee = function () {
            ...
            this.app.delete('/projektArtikelSimkarte/:projekt_artikel_id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var projektArtikelID, projArtikel, simkartenID, error_5;
                var _a, _b;
