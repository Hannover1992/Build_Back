...
(function (factory) {
    ...
    var Acu = (function (_super) {
        ...
        Acu.prototype.read = function () {
            ...
            this.read_for_specific_project_and_subcategory();
            this.read_all();
        };
        Acu.prototype.read_for_specific_project_and_subcategory = function () {
            var _this = this;
        ...
        Acu.prototype.read_all = function () {
            var _this = this;
            this.app.get('/projektArtikelAcu/:unterkategorie_id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        Acu.prototype.update = function () {
            ...
            this.app.put('/projektArtikelAcu', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var projektArtikelData, existingAcu, _a, acu_id, updateData, error_3;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            _a = projektArtikelData.artikel.acu, acu_id = _a.acu_id, updateData = __rest(_a, ["acu_id"]);
        ...
        Acu.prototype.deletee = function () {
            ...
            this.app.delete('/projektArtikelAcu/:projekt_artikel_id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var projektArtikelID, projArtikel, acuID, error_4;
                var _a, _b;
