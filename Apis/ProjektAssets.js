...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../server/ServerSetup", "./KategorienTable"], factory);
    }
    ...
    var KategorienTable_1 = require("./KategorienTable");
    var ProjektAssets = (function (_super) {
        __extends(ProjektAssets, _super);
        function ProjektAssets() {
            var _this = _super.call(this) || this;
            _this.kategorienTable = new KategorienTable_1.KategorienTable();
            return _this;
        }
        ...
        ProjektAssets.prototype.read = function () {
            ...
            this.read_for_specific_project_and_subcategory_assets();
            this.read_all_assets();
        };
        ProjektAssets.prototype.read_for_specific_project_and_subcategory_assets = function () {
            var _this = this;
            this.app.get('/projektArtikelAsset/:projekt_id/:unterkategoriename', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var inputet_projekt_id, inputet_unterkategoriename, articles, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.allow_communikation_from_all_ip_adress(res);
        ...
        ProjektAssets.prototype.read_all_assets = function () {
            var _this = this;
            this.app.get('/projektArtikelAsset/:unterkategorie_id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var kategorie_id, articles, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
