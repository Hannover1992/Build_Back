...
(function (factory) {
    ...
    var Notebook = (function (_super) {
        ...
        Notebook.prototype.read = function () {
            ...
            this.read_for_specific_project_and_subcategory_notebook();
            this.read_all_notebook();
        };
        Notebook.prototype.read_for_specific_project_and_subcategory_notebook = function () {
            var _this = this;
        ...
        Notebook.prototype.read_all_notebook = function () {
            var _this = this;
            this.app.get('/projektArtikelNotebook/:unterkategorie_id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        Notebook.prototype.update = function () {
            ...
            this.app.put('/projektArtikelNotebook', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var projektArtikelData, existingNotebook, _a, notebook_id, notebookData, error_4;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            existingNotebook = _b.sent();
                            if (!existingNotebook) return [3, 4];
                            _a = projektArtikelData.artikel.notebook, notebook_id = _a.notebook_id, notebookData = __rest(_a, ["notebook_id"]);
        ...
        Notebook.prototype.deletee = function () {
            ...
            this.app.delete('/projektArtikelNotebook/:projekt_artikel_id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var projektArtikelID, projArtikel, notebookID, error_5;
                var _a, _b;
