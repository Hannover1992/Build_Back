...
(function (factory) {
    ...
    var KategorienTable = (function (_super) {
        ...
        KategorienTable.prototype.look_up_kategorie_id = function (inputet_unterkategorie_id) {
            var inputet_unterkategorie_id_number = parseInt(inputet_unterkategorie_id);
            var kategorie_id = this.findKategorieIdByUnterkategorieId(inputet_unterkategorie_id_number);
            return kategorie_id;
        };
        KategorienTable.prototype.findKategorieIdByUnterkategorieId = function (unterkategorie_id) {
            return __awaiter(this, void 0, void 0, function () {
                var unterkategorie;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.prisma.unterkategorie.findUnique({
                                where: {
                        ...
                        case 1:
                            ...
                            return [2, unterkategorie.kategorie_id];
                    }
                });
            });
        };
