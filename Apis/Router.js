...
(function (factory) {
    ...
    var Router = (function (_super) {
        ...
        Router.prototype.read = function () {
            ...
            this.read_for_specific_project_and_subcategory_router();
            this.read_all_router();
        };
        Router.prototype.read_for_specific_project_and_subcategory_router = function () {
            var _this = this;
        ...
        Router.prototype.read_all_router = function () {
            var _this = this;
            this.app.get('/projektArtikelRouter/:unterkategorie_id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        Router.prototype.update = function () {
            ...
            this.app.put('/projektArtikelRouter', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var projektArtikelData, existingRouter, _a, router_id, routerData, error_4;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            existingRouter = _b.sent();
                            if (!existingRouter) return [3, 4];
                            _a = projektArtikelData.artikel.router, router_id = _a.router_id, routerData = __rest(_a, ["router_id"]);
                            console.log("the data to udpate");
        ...
        Router.prototype.deletee = function () {
            ...
            this.app.delete('/projektArtikelRouter/:projekt_artikel_id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var projektArtikelID, projArtikel, routerID, error_5;
                var _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
