...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@prisma/client", "jsonwebtoken"], factory);
    }
    ...
    var ServerSetup = (function () {
        ...
        ServerSetup.prototype.authenticate = function (req, res, next) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.validToken(req)];
                        case 1:
                            if (_a.sent()) {
                                next();
                            }
        ...
        ServerSetup.prototype.test_if_user_can_access = function (decoded) {
            return __awaiter(this, void 0, void 0, function () {
                var user, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        ServerSetup.prototype.validToken = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                var decoded;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            decoded = this.decript_secret_key(req);
                            return [4, this.test_if_user_can_access(decoded)];
                        case 1: return [2, _a.sent()];
                    }
                });
            });
        };
        ServerSetup.prototype.decript_secret_key = function (req) {
